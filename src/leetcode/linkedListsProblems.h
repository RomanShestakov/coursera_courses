...
namespace leetcode {
    ...
    //     Given the head of a singly linked list, group all the nodes with odd indices together followed by t    //  he nodes with even indices, and return the reordered list.
